...
class MapMarkerVisual extends StatelessWidget {
  ...
  // Mirrors the web's `.marker-visual.is-selected` treatment: scale(1.15)
  // plus a blurred alpha-tinted silhouette so the shadow follows the SVG
  // outline rather than the square bounding box.
